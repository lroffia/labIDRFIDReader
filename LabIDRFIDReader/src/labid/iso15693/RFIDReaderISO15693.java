...
public interface RFIDReaderISO15693 {
	 ...
	 * @throws labid.reader.RFReaderException If unable to perform operation. With message.
	 */
	 ...
	 */
	ISO15693SysInfo getSystemInformation(byte[] uid) throws RFReaderException;
